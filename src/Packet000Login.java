...
public class Packet000Login extends Packet {
	...
	public Packet000Login(String username, String levelName, double mapX, double mapY, int time, int weather) {
		super(000);
	...
	@Override
	public byte[] getData() {
		return ("000" + this.username + "," + this.levelName + "," + this.mapX + "," + this.mapY + "," + this.time + "," + this.weather).getBytes();
	}
