...
public class Packet9OverheadDamage extends Packet {
	
	private String levelName;
	private double mapX, mapY;
	private int red, green, blue, damage;

	public Packet9OverheadDamage(byte[] data) {
		super(9);
	...
	public Packet9OverheadDamage(String levelName, double mapX, double mapY, int red, int green, int blue, int damage) {
		super(9);
	...
	@Override
	public byte[] getData() {
		return ("9" + this.levelName + "," + this.mapX + "," + this.mapY + "," + this.red + "," + this.green + "," + this.blue + "," + this.damage).getBytes();
	}
