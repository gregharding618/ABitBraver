...
public class Packet025AddDroppedItem extends Packet {
	
	private String levelName, itemType;
	private double mapX, mapY;
	private ArrayList<String> attributes = new ArrayList<String>();

	public Packet025AddDroppedItem(byte[] data) {
		super(025);
	...
	public Packet025AddDroppedItem(String levelName, String itemType, double mapX, double mapY, ArrayList<String> attributes) {
		super(025);
	...
	@Override
	public byte[] getData() {
		String data = "025" + this.levelName + "," + this.itemType + "," + this.mapX + "," + this.mapY + ",";
